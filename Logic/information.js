...
module.exports = class Information
{
    ...
    getHelp()
    {
        this.msg.channel.send(functions.getEmbed().addFields(
            ...
            { name: "Music", value: "play, skip, stop, spot (place a spotify playlist url after this one), shuffle"},
            ...
            { name: "Albums", value: "add_album, generate_album" },
            { name: "Objects", value: "add_object, generate_object" },
            { name: "Films", value: "add_film, generate_film" },
